...
@section('contenido')
  <head>
    <meta charset="utf-8">
    {{Form::open(['route' => 'editacl','files' => true])}}
  {{Form::token()}}
  ...
  <body>
    <div align='center'>
      ...
      <table>
        ...
        <tr>
          <td>  ID:</td>
          <td>  @if($errors->first('idcl'))<p><i> {{ $errors->first('idcl') }}</i></p> @endif
                 {{Form::text('idcl',$consulta->idcl,['readonly','class' => 'form-control'])}}</td>
        </tr>
        ...
        <tr>
          ...
          <td>     @if($errors->first('sexo')) <p><i> {{ $errors->first('sexo') }} </i></p>@endif
              {{Form::text('sexo',$consulta->sexo,['readonly','class' => 'form-control'])}}</td>
        </tr>
        ...
        <tr>
          ...
          <td>     @if($errors->first('contraseña')) <p><i> {{ $errors->first('contraseña') }} </i></p>@endif
              {{Form::text('contraseña',$consulta->contraseña, ['class' => 'form-control'])}}
</td>
        </tr>
